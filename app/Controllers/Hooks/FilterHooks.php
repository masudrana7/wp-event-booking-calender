...
namespace WPEBCalender\App\Controllers\Hooks;
...
class FilterHooks
{
	...
	public static function init_hooks()
	{
		...
		add_filter('plugin_action_links_' . WPEBCALENDER_BASENAME, [__CLASS__, 'plugins_setting_links']);
	...
	{
		$links['mediaedit_settings'] = '<a href="' . admin_url('admin.php?page=wpebcalender-admin') . '">' . esc_html__('Start Editing', 'wpebcalender') . '</a>';
		/*
		 * TODO:: Next Version
		 *
		 */
		if (!Fns::is_plugins_installed('media-library-tools-pro/media-library-tools-pro.php')) {
			// $links['wpebcalender_pro'] = sprintf( '<a href="#" target="_blank" style="color: #39b54a; font-weight: bold;">' . esc_html__( 'Go Pro', 'wp-media' ) . '</a>' );
		}
		return $links;
	}
	/**
